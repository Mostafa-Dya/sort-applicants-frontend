...
export class GovernorateService {
  ...
  getGovernorateDataId(governorate_id: number): Observable<any> {
    return this.http.get<any>(
      `${environment.api}governorates-get/${governorate_id}`,
    );
  }
  ...
  updateGovernorateData(governorate_id: number, data): Observable<any> {
    return this.http.put<any>(
      `${environment.api}update-governorates/${governorate_id}`,
      data,
    );
  }

  deleteGovernorateData(
    ...
    return this.http.delete<any>(
      `${environment.api}delete-governorates/${governorate_id}`,
      { params },
    );
  }
}
